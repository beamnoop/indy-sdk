...
/// Ledger*
#[no_mangle]
pub extern "C" fn indy_create_pool_ledger_config(command_handle: CommandHandle,
...
/// Ledger*
#[no_mangle]
pub extern "C" fn indy_open_pool_ledger(command_handle: CommandHandle,
                                    config_name: *const c_char,
                                    config: *const c_char,
                                    cb: Option<extern "C" fn(command_handle_: CommandHandle,
                                                         err: ErrorCode,
...
/// Ledger*
#[no_mangle]
pub extern "C" fn indy_refresh_pool_ledger(command_handle: CommandHandle,
                                       handle: PoolHandle,
                                       cb: Option<extern "C" fn(command_handle_: CommandHandle,
                                                            err: ErrorCode)>) -> ErrorCode {
...
/// #Errors
#[no_mangle]
pub extern "C" fn indy_list_pools(command_handle: CommandHandle,
                              cb: Option<extern "C" fn(command_handle_: CommandHandle,
                                                   err: ErrorCode,
...
/// Ledger*
#[no_mangle]
pub extern "C" fn indy_close_pool_ledger(command_handle: CommandHandle,
                                     handle: PoolHandle,
                                     cb: Option<extern "C" fn(command_handle_: CommandHandle,
                                                          err: ErrorCode)>) -> ErrorCode {
...
/// Ledger*
#[no_mangle]
pub extern "C" fn indy_delete_pool_ledger_config(command_handle: CommandHandle,
                                             config_name: *const c_char,
                                             cb: Option<extern "C" fn(command_handle_: CommandHandle,
                                                                  err: ErrorCode)>) -> ErrorCode {
...
/// Common*
#[no_mangle]
pub extern "C" fn indy_set_protocol_version(command_handle: CommandHandle,
